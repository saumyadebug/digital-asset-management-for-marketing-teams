...
let galleryState = { page:1, view:'grid' };
...
function getFilteredAssets(){
  ...
  let list = DAM_DATA.assets.filter(a => {
    ...
    <div class="asset-card">
      <div class="asset-thumb" style="background:linear-gradient(135deg, ${a.color}, ${a.color}CC);">
        ...
        <div class="thumb-overlay">
          <button class="btn-icon-sm" title="Preview" onclick="window.location.href='asset-details.html?id=${a.id}'"><i class="bi bi-eye"></i></button>
          <button class="btn-icon-sm" title="Download" onclick="damToast('Downloading ${a.name}...','info')"><i class="bi bi-download"></i></button>
          <button class="btn-icon-sm" title="Share" data-bs-toggle="modal" data-bs-target="#shareModal"><i class="bi bi-share"></i></button>
        </div>
      ...
      <div class="p-3">
        ...
        <div class="d-flex gap-1">
          ...
          <button class="btn btn-outline-secondary btn-sm flex-fill" onclick="damToast('Downloading ${a.name}...','info')"><i class="bi bi-download"></i></button>
          ...
          <button class="btn btn-outline-danger btn-sm flex-fill" onclick="damConfirm('Delete &quot;${a.name}&quot;? This cannot be undone.', () => damToast('${a.name} deleted.','danger'))"><i class="bi bi-trash"></i></button>
        </div>
      </div>
    </div>
  </div>`;
    ...
    <tr>
      ...
      <td>
        <div class="d-flex gap-1">
          ...
          <button class="btn btn-outline-secondary btn-icon-sm" title="Download" onclick="damToast('Downloading ${a.name}...','info')"><i class="bi bi-download"></i></button>
          <button class="btn btn-outline-danger btn-icon-sm" title="Delete" onclick="damConfirm('Delete &quot;${a.name}&quot;?', () => damToast('${a.name} deleted.','danger'))"><i class="bi bi-trash"></i></button>
        </div>
      </td>
    </tr>
  `).join('');
